         ...
         Config &config)
{
    ...
    do
    {
        std::cout << InformationMsg("monkeytips v"
    ...
    {
        std::cout << WarningMsg("It looks like monkeytipsd isn't open!")
                  << std::endl << std::endl
                  << WarningMsg("Ensure monkeytipsd is open and has finished "
                                "initializing.")
                  << std::endl
                  << WarningMsg("If it's still not working, try restarting "
                                "monkeytipsd. The daemon sometimes gets stuck.")
                  << std::endl
                  << WarningMsg("Alternatively, perhaps monkeytipsd can't "
