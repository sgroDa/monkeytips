...
void viewWalletMsg()
{
    std::cout << InformationMsg("Please remember that when using a view wallet "
              ...
              << std::endl << "This means if you received 100 dicK and then "
              << "sent 50 dicK, your balance would appear to still be 100 "
              << "dicK." << std::endl
...
void connectingMsg()
{
    std::cout << std::endl << "Making initial contact with monkeytipsd."
              << std::endl
